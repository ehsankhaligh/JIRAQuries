--Plugin is not installed or the version does not match 
select pro.pluginname, pro.pluginversion, QA.pluginname, QA.pluginversion
from dbo.pluginversion as pro 
FULL JOIN [cosp-dv-shsql05\QA2012].[JIRA].[dbo].[pluginversion] as QA 
on  (pro.pluginname = QA.pluginname and pro.pluginversion = QA.pluginversion) 
where pro.id >= 12082
